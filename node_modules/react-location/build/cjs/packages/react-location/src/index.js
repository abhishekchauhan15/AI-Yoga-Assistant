...
var RouterInstance = /*#__PURE__*/function (_Subscribable2) {
  ...
  function RouterInstance(_ref4) {
    ...
    _this4.cleanMatchCache = function () {
      ...
      var activeMatchIds = [].concat((_assertThisInitialize = (_assertThisInitialize2 = assertThisInitialized["default"](_this4)) == null ? void 0 : _assertThisInitialize2.state.matches) != null ? _assertThisInitialize : [], (_assertThisInitialize3 = (_assertThisInitialize4 = assertThisInitialized["default"](_this4)) == null ? void 0 : (_assertThisInitialize5 = _assertThisInitialize4.pending) == null ? void 0 : _assertThisInitialize5.matches) != null ? _assertThisInitialize3 : []).map(function (d) {
        return d.id;
      });
...
var RouteMatch = function RouteMatch(unloadedMatch) {
  ...
  this.load = function (opts) {
    ...
    _this5.loaderPromise = (!importer ? Promise.resolve() : importer({
      ...
      _this5.route = _extends["default"]({}, _this5.route, imported);
  ...
  function MatchLoader(router, nextLocation) {
    ...
    _this6.loadData = _async(function (_temp) {
      ...
      _this6.matches.forEach(function (match, index) {
        ...
        match.assignMatchLoader == null ? void 0 : match.assignMatchLoader(assertThisInitialized["default"](_this6));
...
var Link = function Link(_ref10) {
  ...
  var _ref10$to = _ref10.to,
    ...
    return {};
      ...
      _ref = _ref10._ref,
      rest = objectWithoutPropertiesLoose["default"](_ref10, _excluded4);
  ...
  var _ref11 = isActive ? getActiveProps() : {},
      ...
      activeRest = objectWithoutPropertiesLoose["default"](_ref11, _excluded5); // Get the inactive props
  ...
  var _ref12 = isActive ? {} : getInactiveProps(),
      ...
      inactiveRest = objectWithoutPropertiesLoose["default"](_ref12, _excluded6);
...
function useMatchRoute() {
  ...
  return useLatestCallback(function (_ref13) {
    var pending = _ref13.pending,
        matchLocation = objectWithoutPropertiesLoose["default"](_ref13, _excluded7);
...
function MatchRoute(_ref14) {
  var children = _ref14.children,
      rest = objectWithoutPropertiesLoose["default"](_ref14, _excluded8);
