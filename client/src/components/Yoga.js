...
import Vrksana from "../images/vrksana.jpg";
import Adho from "../images/adho-mukha.png";
import Balasana from "../images/balasana.jpg";
import Tadasan from "../images/tad-asan.jpg";
import Trikon from "../images/trikonasana.jpg";
import Virbhadra from "../images/virabhadrasana.jpg";
import PracticeR from "../images/Yoga practice right.png";
import PracticeL from "../images/Yoga practice left.png";
    ...
    <div className="yoga">
      ...
      <div className="group-1">
        <div className="card-1">
          ...
          <p className="asan-para-1">
            A classic standing posture, It establishes strength and balance, and
        ...
        <div className="card-2">
          ...
          <p className="asan-para-1">
            It strengthens the core and improves circulation, while providing
            full-body stretch.
          </p>
          <p className="btn">
            <FaPlayCircle />
      ...
      <div className="group-2">
        <div className="card-4">
          ...
          <p className="asan-para-1">
            The foundation of all standing poses, It makes a resting pose, or
            tool to improve posture.
          </p>
          <p className="btn">
            <FaPlayCircle />
          </p>
        ...
        <div className="card-5">
          ...
          <p className="asan-para-1">
            It is a quintessential standing pose that stretches and strengthens
            the whole body.
          </p>
          <p className="btn">
            <FaPlayCircle />
        ...
        <div className="card-6">
          ...
          <p className="asan-para-1">
            It is a foundational yoga pose that balances flexibility and
            strength in true warrior fashion.
          </p>
          <p className="btn">
            <FaPlayCircle />
          </p>
